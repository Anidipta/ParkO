    ...
    <main className="min-h-screen bg-gradient-to-br from-secondary via-background to-primary/20">
      ...
      <div className="mx-auto max-w-2xl px-4 py-12 flex items-center justify-center min-h-[calc(100vh-80px)]">
        <div className="bg-card border border-border rounded-xl p-8 w-full">
          ...
          <p className="text-muted-foreground mb-8">Manage your parking spaces and earnings</p>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link href="/owner/signup" className="text-secondary font-semibold hover:underline">
              Sign Up
            </Link>
          </p>
        </div>
